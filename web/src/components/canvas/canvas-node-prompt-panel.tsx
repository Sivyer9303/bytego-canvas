...
function buildNodeConfig(globalConfig: AiConfig, node: CanvasNodeData, mode: CanvasNodeGenerationMode): AiConfig {
    return {
        ...
        videoGenerationType: node.metadata?.videoGenerationType || globalConfig.videoGenerationType || defaultConfig.videoGenerationType,
...
function videoConfigPatch(key: keyof AiConfig, value: string) {
    ...
    if (key === "videoGenerationType") return { videoGenerationType: value };
