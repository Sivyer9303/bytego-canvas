export default {
    meta: {
        title: "Bytego Canvas",
        description: "A Bytego canvas creation tool",
    },
    ...
    settingsPanels: {
        ...
        video: { title: "Video settings", generationType: "Play mode", modes: { text2video: "Text to video", image2video: "Image to video", multi_image: "Multi-image", start_end: "First & last frame", reference_audio: "Reference audio", reference_videos: "Reference video" }, modeHints: { text2video: "Do not send reference images, videos, or audio", image2video: "Requires exactly 1 reference image", multi_image: "Requires 2–9 reference images", start_end: "Requires exactly 2 reference images: first as first frame, second as last frame", reference_audio: "Requires 1–9 reference images and 1 reference audio. Connect audio on the canvas", reference_videos: "Requires 1–3 reference videos; companion images and audio are optional. Connect videos on the canvas" }, quality: "Quality", size: "Size", seconds: "Seconds", resolution: "Resolution", ratio: "Aspect ratio", duration: "Duration", smart: "Smart", output: "Output", generateAudio: "Generate audio", watermark: "Add watermark", adaptive: "Adaptive", sizes: { landscape: "Landscape", portrait: "Portrait", square: "Square", widescreen: "Widescreen", tall: "Tall", auto: "Auto" }, ratios: { landscape: "Landscape", portrait: "Portrait", square: "Square", standardLandscape: "Standard landscape", standardPortrait: "Standard portrait", cinematic: "Cinematic", adaptive: "Adaptive" } },
    ...
    canvas: {
        defaultTitle: "Bytego Canvas {{count}}",
        ...
        export: { defaultProjectName: "Bytego Canvas", defaultNodesName: "Canvas elements", item: "Element" },
        createMenu: {
    ...
    home: {
        ...
        description: "Generate, connect, and reshape <content>images, text, and graphics</content> in <canvas>Bytego Canvas</canvas>, turning one-off generations into a continuous creative process.",
        start: "Get started",
    ...
    config: {
        ...
        migration: {
            ...
            description: "Pack canvases, assets, generation history and plugin data into a single zip file to move everything to another device or browser. API keys are never exported.",
            export: "Export all data",
            import: "Import all data",
            estimate: "About {{size}}",
            estimateHint: "The final archive size may differ",
            exportSuccess: "Exported {{count}} records",
            exportFailed: "Export failed",
            importSuccess: "Imported {{count}} records, please reload the page",
            importFailed: "Import failed",
            confirmTitle: "Importing replaces all local data",
            confirmDescription: "Canvases, assets and generation history in this browser will be fully replaced by the backup, and this cannot be undone. Export the current data first if needed.",
            confirmOk: "Replace and import",
            reload: "Reload page",
            stageScan: "Scanning local data",
            stagePack: "Packing {{store}}",
            stageExported: "Export finished",
            stageRead: "Reading backup file",
            stageWrite: "Writing {{store}}",
            stageImported: "Import finished",
            missingManifest: "Corrupted backup: manifest.json is missing",
            brokenManifest: "Corrupted backup: manifest.json cannot be parsed",
            notBackup: "This is not an Infinite Canvas backup file",
            versionMismatch: "Backup format version {{fileVersion}} does not match the current version {{appVersion}}. Use a backup exported by the same version.",
            missingStores: "Corrupted backup: store manifest is missing",
        },
        promptSources: {
            add: "Add source",
